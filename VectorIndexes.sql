...
-- Approach 1: If you do not yet have a table with vectors created.
...
-- Approach 2: If you already have a table with vectors created.
declare
   resp_json clob;
BEGIN
